...
WITH test_nb AS (
    ...
    SELECT 'TT_Match1'::text,                  8,          7         UNION ALL
    SELECT 'TT_Match2'::text,                  9,         11         UNION ALL   
