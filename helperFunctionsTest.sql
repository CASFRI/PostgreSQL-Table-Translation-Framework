...
WITH test_nb AS (
    ...
    SELECT 'TT_Concat'::text,                 11,         10         UNION ALL
    SELECT 'TT_Copy'::text,                   12,          5         UNION ALL
    SELECT 'TT_Lookup'::text,                 13,         17         UNION ALL
