...
The ROW_TRANSLATION_RULE special row specify that only source rows for which the attribute "sp1" is not NULL must be translated. Other source rows are skipped.
