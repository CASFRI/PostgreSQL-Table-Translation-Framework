...
DROP FUNCTION IF EXISTS TT_CountNotNull(text, text, text, text);
DROP FUNCTION IF EXISTS TT_CountNotNull(text, text, text);
DROP FUNCTION IF EXISTS TT_CountNotNull(text, text);
